...
class TestClickHouseSettings:
    ...
    def test_default_user(self, monkeypatch):
    ...
    def test_read_host_from_env(self, monkeypatch):
    ...
    def test_read_port_from_env(self, monkeypatch):
    ...
    def test_read_user_from_env(self, monkeypatch):
    ...
    def test_read_password_from_env(self, monkeypatch):
    ...
    def test_read_database_from_env(self, monkeypatch):
    ...
    def test_tailnet_ip_none_by_default(self, monkeypatch):
    ...
    def test_read_tailnet_ip_from_env(self, monkeypatch):
    ...
    def test_effective_host_without_tailnet_ip(self, monkeypatch):
    ...
    def test_effective_host_with_tailnet_ip_overrides(self, monkeypatch):
...
class TestOzoneSettings:
    ...
    def test_default_service_url_none(self, monkeypatch):
    ...
    def test_default_handle_none(self, monkeypatch):
    ...
    def test_default_admin_password_none(self, monkeypatch):
    ...
    def test_default_did_none(self, monkeypatch):
    ...
    def test_default_pds_none(self, monkeypatch):
    ...
    def test_read_service_url_from_env(self, monkeypatch):
    ...
    def test_read_handle_from_env(self, monkeypatch):
    ...
    def test_read_admin_password_from_env(self, monkeypatch):
    ...
    def test_read_did_from_env(self, monkeypatch):
    ...
    def test_read_pds_from_env(self, monkeypatch):
    ...
    def test_is_configured_false_when_all_none(self, monkeypatch):
    ...
    def test_is_configured_false_when_partial(self, monkeypatch):
    ...
    def test_is_configured_true_when_all_set(self, monkeypatch):
